...
class movistarPhoneCatalog:
    ...
    def getAllItems(self):
        models = self.driver.find_elements_by_xpath('//h2[contains(@class, "conte-product-item-name")]/a')
        prices = self.driver.find_elements_by_xpath('//div[contains(@class, "itemDetail")]/p[2]')
